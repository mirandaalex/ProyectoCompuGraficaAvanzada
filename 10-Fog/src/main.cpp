...
void applicationLoop() {
	...
	while (psi) {
		...
		shaderMulLighting.setFloat("density", 0.015f);
		shaderMulLighting.setFloat("gradient", 0.5f);
		shaderTerrain.setVectorFloat3("fogColor", glm::value_ptr(glm::vec3(0.5, 0.5, 0.4)));
		shaderTerrain.setFloat("density", 0.015f);
		shaderTerrain.setFloat("gradient", 0.5f);
