...
Shader shaderDepth;
//shader para visualzar (ayuda) el buffer de profundidad
...
Box boxIntro;
Box boxViewDepth; //Ayuda visual para el shadowmapping
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	/****************Inicializacion del framebuffer para almacenar la profundidad (ViewDepth)************************/
	...
	glFramebufferTexture2D(GL_TEXTURE_2D, GL_DEPTH_ATTACHMENT,GL_TEXTURE_2D,depthMap,0);
